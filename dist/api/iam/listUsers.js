...
function listUsers(_a) {
    var accessKey = _a.accessKey, secretKey = _a.secretKey, region = _a.region, pathPrefix = _a.pathPrefix;
    return __awaiter(this, void 0, void 0, function () {
        var client, params, data, users;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    users = [];
                    _b.label = 1;
                case 1: return [4 /*yield*/, client.send(new client_iam_1.ListUsersCommand(params))];
                case 2:
                    data = _b.sent();
