        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.send(new client_iam_1.CreateAccessKeyCommand({ UserName: userName }))];
                case 1:
                    data = _b.sent();
                    if (!data.AccessKey) {
                        throw new Error("No access key was returned from calling AWS IAM API (createAccessKey)");
                    }
                    return [2 /*return*/, data.AccessKey];
            }
        });
    });
}
exports.createAccessKey = createAccessKey;
//# sourceMappingURL=createAccessKey.js.map